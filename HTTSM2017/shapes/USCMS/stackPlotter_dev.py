...
cate={options.ch+"_vbf":"VBF category", options.ch+"_boosted":"boosted", options.ch+"_0jet":"0jet"}#, options.ch+"_inclusive":"inclusive"} # vlaue is tag on the plot such as high Diget Mass
titleMap = {
    'mjj':'Dijet Mass [GeV]',
    'NN_disc':'NN disc',
...
for cat in cate.keys():
    ...
    if options.is_JetFakes:
        postfix+="_FF"
    plot2.SaveAs("Unrolled_"+options.plottitle+"_"+cate[cat]+"_"+options.ch+postfix+options.whichFSA+".pdf")
